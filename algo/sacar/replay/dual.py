...
class DualReplay(Replay):
    def __init__(self, config, *keys, state_shape=None):
        ...
        # we want good samples to linger longer, which we thinks may 
        # be good for learning in the sparse reward problem where 
        # positive rewards are rare. On the other hand, 
