...
from algo.lka_common.elements.strategy import Strategy as Strategy, create_strategy


def compute_value(self: Strategy, env_output):
...
Strategy.compute_value = compute_value
