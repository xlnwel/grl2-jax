...
def run_eval(env, agents, a1_future, a2_future, prefix=None):
    if a1_future:
    ...
    info = {f'{prefix}_{a1}_{a2}_{k}' if prefix else f'{a1}_{a2}_{k}': v for k, v in info.items()}

    return info


def run_comparisons(env, agents, prefix=None):
    final_info = {}
