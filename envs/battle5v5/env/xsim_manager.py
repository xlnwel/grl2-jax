...
from envs.battle5v5.config import RTMNum
from envs.battle5v5.config import HostID
...
class XSimManager(object):
    def __init__(self, time_ratio: int, address: str, image_name: str = 'xsim5:v1.0', mode: str = 'host'):
        ...
        print('当前引擎地址：{}'.format(self.address))
    ...
    def close_env(self):
        ...
        print("docker ps -a -f 'name={}' --format '{{{{.Status}}}}'".format(self.docker_name))
