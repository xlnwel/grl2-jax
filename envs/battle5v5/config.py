...
class InitLoc:
    RED = {
        0: {'X': [-135000, -125000], 'Y': [-1000, 1000], 'Z': 9000, 'heading': 90},
        1: {'X': [-135000, -125000], 'Y': [-100000, -1000], 'Z': 9000, 'heading': 90},
        2: {'X': [-135000, -125000], 'Y': [-100000, -1000], 'Z': 9000, 'heading': 90},
        3: {'X': [-135000, -125000], 'Y': [1000, 100000], 'Z': 9000, 'heading': 90},
        4: {'X': [-135000, -125000], 'Y': [1000, 100000], 'Z': 9000, 'heading': 90},
    }

    BLUE = {
        0: {'X': [125000, 135000], 'Y': [-1000, 1000], 'Z': 9000, 'heading': 90},
        1: {'X': [125000, 135000], 'Y': [-100000, -1000], 'Z': 9000, 'heading': 90},
        2: {'X': [125000, 135000], 'Y': [-100000, -1000], 'Z': 9000, 'heading': 90},
        3: {'X': [125000, 135000], 'Y': [1000, 100000], 'Z': 9000, 'heading': 90},
        4: {'X': [125000, 135000], 'Y': [1000, 100000], 'Z': 9000, 'heading': 90},
    }