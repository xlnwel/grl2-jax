...
def rollout(agent, agent_params, model, dynamics_params, rng, env_output, n_steps):
    data_list = []
    ...
    for _ in jnp.arange(n_steps):
        ...
        new_env_output, _, _ = model.raw_action(dynamics_params, env_rng, model_inp)
...
@timeit
def branched_rollout(agent, agent_params, dynamics, dynamics_params, routine_config, rng, lka_aids):
