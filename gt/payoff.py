...
class PayoffTable:
  ...
  def save(self):
    # pickle.save(
    #   {'payoffs': self.payoffs, 'counts': self.counts}, 
    #   filedir=self.payoff_dir, filename=self.name, name='payoffs'
    # )
...
class PayoffTableWithModel(PayoffTable):
  ...
  def save(self):
    ...
    #   'counts': self.counts, 
    #   'model2sid': self.model2sid, 
    #   'sid2model': self.sid2model
    # }
    # pickle.save(
    #   data, filedir=self.payoff_dir, filename=self.name, name='payoffs'
    # )
    with open(self._path, 'wb') as f:
      cloudpickle.dump(
  ...
  def restore(self):
    ...
    # self.payoffs = data['payoffs']
    # self.counts = data['counts']
    # self.model2sid = data['model2sid']
    # self.sid2model = data['sid2model']
    if os.path.exists(self._path):
      with open(self._path, 'rb') as f:
