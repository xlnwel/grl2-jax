...
class UnityEnv:
    ...
    def init_red_fly_model(self):
        if platform.system() == 'Windows':
            ...
            directory = [f"/home/ubuntu/wuyunkun/hm/logs/unity-combat_fly_control/sync-hm/{FLY_NAME}/seed=None/a0/i1-v1"]
