...
class UnityEnv:
    ...
    def step(self, actions):
        ...
        self._info = [dict(
            ...
            left_missile_blue0=self.blue_missle_left[i][0],
            left_missile_blue1=self.blue_missle_left[i][1],
    ...
    def _get_done_and_reward(self):
        ...
        for i in range(self.n_envs):
            ...
            if self.alive_units[i][0] != 1 and self.alive_units[i][1] != 1 and self.alive_units[i][2] == 1 and\
