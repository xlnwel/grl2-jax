...
class UnityEnv:
    def __init__(
        ...
        # It specifies which agent controls the unit.
    ...
    def init_red_fly_model(self):
        ...
        path = "/home/ubuntu/wuyunkun/hm/logs/unity-combat2d/sync_sim-hm/0530-frame_skip=10/a0/v1.1/params.pkl"
